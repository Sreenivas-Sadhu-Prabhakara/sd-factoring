package com.bank.bian.factoring.model;
...
/**
 * The BIAN control record for this service domain: "Factoring Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Factoring Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Factoring Facility Fulfillment Arrangement";
